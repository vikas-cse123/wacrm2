...
function DashboardShellInner({ children }: { children: React.ReactNode }) {
  const { user, loading, sessionStatus, accountId } = useAuth();
  ...
  // Desktop collapse preference — shell-owned so it survives route
  // changes; localStorage-backed so it survives refresh.
  const { collapsed, toggle: toggleCollapse } = useSidebarCollapsed(accountId);
