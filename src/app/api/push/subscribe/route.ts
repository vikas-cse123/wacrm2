...
export async function POST(request: Request) {
  try {
    ...
    // Upsert on the unique `endpoint`. If this browser already had a
    // subscription (possibly under a different user on a shared device),
    // it is re-pointed to the current user/account.
