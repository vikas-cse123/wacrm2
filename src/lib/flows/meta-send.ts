...
/**
 * Send a CTA-URL (link button) message from the Flows engine. Same
 * lookup / phone-retry / persistence as engineSendMedia; auto-advances
 * after the send lands (the button opens a link, it doesn't reply).
 */
